...
const DATA = {
  ...
  site: {
    ...
    domain: "eagleppf.in",
    build: "20260926-M",   // footer me dikhta hai — kaunsa version live hai, turant pata chal jaye
  ...
  precut: {
    ...
    image: "assets/img/products/precut-1.jpg",
    image2: "assets/img/products/precut-2.jpg",
    cardImage: "assets/img/products/precut-card.jpg",   // home page ka Precut card thumbnail — poora composite (Ceramic/Graphene card jaisa)
  ...
  graphene: {
    ...
    image: "assets/img/products/graphene-coating-v2.jpg",
...
const ASSETS = {
  ...
  about:  "assets/img/about-eagle-range.jpg"     // Home > About Eagle PPF ki photo
