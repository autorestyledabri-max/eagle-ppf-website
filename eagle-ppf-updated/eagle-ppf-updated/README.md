...
│   ├── img/                    eagle-mark.png (header), eagle-lockup-chrome.png (footer),
│   │                           cta-band-bg.jpg (CTA band background), about-eagle-studio-full.jpg
│   └── img/products/           crystal, silver, gold, diamond, platinum,
│                               precut, ceramic, graphene — asli packshots
...
├── favicon.ico, favicon-*.png   browser tab / bookmark / Google result icon
├── apple-touch-icon.png        iPhone / iPad home screen icon (180×180)
├── android-chrome-*.png, maskable-512x512.png   Android / Chrome install icons
├── site.webmanifest · browserconfig.xml · mstile-150x150.png   app + Windows icon config
├── 404.html                    asli 404 page (Cloudflare galat URL par homepage na de)
├── UPDATE-2026-09-25.md        is update me kya badla + deploy/test guide
