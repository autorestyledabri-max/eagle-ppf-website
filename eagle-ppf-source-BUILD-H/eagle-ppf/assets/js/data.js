...
const DATA = {
  ...
  site: {
    ...
    domain: "eagleppf.in",
    build: "20260917-H",   // footer me dikhta hai — kaunsa version live hai, turant pata chal jaye
    ...
    meta: {
      ...
      "/products":  { title: "PPF Range — Crystal, Silver, Gold, Diamond, Platinum | Eagle PPF", desc: "Five grades of paint protection film: 190 to 220 microns, replacement cover and warranties up to lifetime." },
      ...
      "/ceramic":   { title: "Ceramic Coating — Eagle PPF", desc: "Unmatched gloss, hydrophobic protection and easier maintenance. The Eagle Shield over your paint." },
      "/distributor": { title: "Become a distributor — Eagle PPF", desc: "Distribution and dealership opportunities with Eagle PPF." },
      "/contact":   { title: "Contact Eagle PPF — New Delhi", desc: "Call or WhatsApp +91 84477 66815. Dabri-Palam Road, Dashrath Puri, New Delhi. Tuesday to Sunday, 10:30 AM to 7:00 PM." }
    }
  },
  ...
  company: {
    ...
    values: [
      ...
      { title:"Customer trust", text:{ ph:false, text:"Clear grades, stated warranties and replacement cover, so an owner knows exactly what they are buying." } }
    ],
    capabilities: [
      ...
      "Unlimited replacement cover on selected grades",
      "Pan-India service"
    ],
    pillars: [
      ...
      { title:"Warranty in writing", text:{ ph:false, text:"Every grade carries a stated warranty, and selected grades include unlimited replacement cover." } }
    ]
  },

  /* ---- data/contact.ts -------------------------------------------------- */
  contact: {
    address:  { ph:false, text:"Block B, 76A, Dabri\u2013Palam Rd, Vaishali Colony, Dashrath Puri, New Delhi \u2013 110045" },
    ...
    mapsLink: "https://www.google.com/maps/place/EAGLE+PPF/@28.6077065,77.0825251,17z/data=!3m1!4b1!4m6!3m5!1s0x390d1b169ade6621:0x81537706888f6e1b!8m2!3d28.6077065!4d77.0825251",
    mapEmbed: "https://www.google.com/maps?q=28.6077065,77.0825251&z=17&output=embed",
  ...
  products: [
    {
      ...
      specifications:[
        ...
        { label:"Replacement cover", value:"Not included" },
    ...
    },
    {
      ...
      shortDescription:{ ph:false, text:"Thicker film with replacement cover for daily driving." },
      description:{ ph:false, text:"A step up in durability and thickness, Silver offers stronger everyday protection backed by our replacement guarantee for added peace of mind." },
      gallery:[],
      features: COMMON_FEATURES,
      specifications:[
        { label:"Thickness",        value:"190 micron" },
        { label:"Replacement cover", value:"3 years unlimited replacement" },
        { label:"Warranty",          value:"5 years" },
        { label:"Position in range", value:"Grade 2 of 5" }
      ],
      applications:["Full body","Front end","High-impact panels","Doors and sills"],
      warranty:{ ph:false, text:"5 years warranty, with 3 years unlimited replacement." }
    },
    {
      ...
      shortDescription:{ ph:false, text:"Thicker film and a longer replacement window." },
      description:{ ph:false, text:"Built for car owners who want extended protection and confidence, Gold combines a thicker film with a longer replacement window." },
      gallery:[],
      features: COMMON_FEATURES,
      specifications:[
        { label:"Thickness",        value:"200 micron" },
        { label:"Replacement cover", value:"5 years unlimited replacement" },
        { label:"Warranty",          value:"5 years" },
        { label:"Position in range", value:"Grade 3 of 5" }
      ],
      applications:["Full body","Front end","High-impact panels","Doors and sills"],
      warranty:{ ph:false, text:"5 years warranty, with 5 years unlimited replacement." }
    },
    {
    ...
    },
    {
      ...
      shortDescription:{ ph:false, text:"The top of the range: lifetime warranty, unlimited replacement." },
      description:{ ph:false, text:"The pinnacle of our range. Platinum offers unmatched thickness, unlimited replacement coverage, and a lifetime warranty — true end-to-end protection for the life of your vehicle." },
      gallery:[],
      features: COMMON_FEATURES,
      specifications:[
        { label:"Thickness",        value:"220 micron" },
        { label:"Replacement cover", value:"Unlimited replacement" },
        { label:"Warranty",          value:"Lifetime" },
        { label:"Position in range", value:"Grade 5 of 5" }
      ],
      applications:["Full body","Front end","High-impact panels","Doors and sills"],
      warranty:{ ph:false, text:"Lifetime warranty, with unlimited replacement cover." }
    }
  ],
  ...
  benefits: [
    ...
    { title:"Wash and swirl marks",        text:"Day-to-day cleaning marks stay on a layer that can be replaced.", icon:"sparkle" },
  ...
  distributor: {
    ...
    benefits: [
      ...
      { title:"Warranty behind the product", text:{ ph:false, text:"Every grade carries a stated warranty, and selected grades include unlimited replacement cover." } },
...
/* ==========================================================================
   ASSETS — logo files live in assets/img/. Replace these two files and the
   whole site updates; no component references the logo directly.
   ========================================================================== */
const ASSETS = {
  mark:   "assets/img/eagle-mark.png",
  lockup: "assets/img/eagle-lockup.png"
};
